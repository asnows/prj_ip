...
#
# Generated by export_simulation on Mon Aug 12 16:38:35 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_maxtrix3x3.sh' script.

./fifo_maxtrix3x3.sh -reset_run
...
./fifo_maxtrix3x3.sh -noclean_files

For more information on the script, please type './fifo_maxtrix3x3.sh -help'.
