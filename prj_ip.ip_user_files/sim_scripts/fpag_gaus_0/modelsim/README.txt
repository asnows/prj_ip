...
#
# Generated by export_simulation on Wed Oct 09 08:57:40 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './fpag_gaus_0.sh' script.

./fpag_gaus_0.sh -reset_run
...
./fpag_gaus_0.sh -noclean_files

For more information on the script, please type './fpag_gaus_0.sh -help'.
