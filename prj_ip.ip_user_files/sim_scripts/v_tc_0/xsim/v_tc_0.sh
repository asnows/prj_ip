...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_lite_ipif_v3_0_4 -L v_tc_v6_1_12 -L xil_defaultlib -L secureip -L xpm --snapshot v_tc_0 xil_defaultlib.v_tc_0 -log elaborate.log
}
