...
HD_PWD='E:/WorkSpace/project/FPGA/prj_ip/prj_ip/prj_ip.runs/fpag_gaus_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpag_gaus_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpag_gaus_0.tcl
