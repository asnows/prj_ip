...
HD_PWD='E:/WorkSpace/project/FPGA/prj_ip/prj_ip/prj_ip.runs/fifo_CannyNMS_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_CannyNMS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_CannyNMS.tcl
