...
HD_PWD='E:/WorkSpace/project/FPGA/prj_ip/prj_ip/prj_ip.runs/fifo_SobelDir_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_SobelDir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_SobelDir.tcl
