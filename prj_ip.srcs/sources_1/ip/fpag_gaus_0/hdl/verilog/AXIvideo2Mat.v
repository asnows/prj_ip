...
reg   [0:0] exitcond_reg_388;
reg   [0:0] brmerge_reg_397;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_reg_259;
reg    img_data_stream_V_blk_n;
reg   [31:0] t_V_3_reg_188;
reg   [0:0] eol_reg_199;
reg   [0:0] eol_1_reg_211;
reg   [7:0] axi_data_V_1_reg_222;
reg   [0:0] axi_last_V_3_reg_270;
reg   [7:0] axi_data_V_3_reg_282;
reg    ap_block_state1;
reg   [7:0] tmp_data_V_reg_359;
reg   [0:0] tmp_last_V_reg_367;
wire   [0:0] exitcond5_fu_313_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_318_p2;
reg   [31:0] i_V_reg_383;
wire   [0:0] exitcond_fu_324_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op58_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_329_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] brmerge_fu_338_p2;
...
reg   [0:0] ap_phi_mux_eol_2_phi_fu_262_p4;
reg   [0:0] axi_last_V1_reg_157;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [7:0] axi_data_V1_reg_167;
reg   [31:0] t_V_reg_177;
reg   [0:0] ap_phi_mux_eol_phi_fu_203_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_phi_fu_238_p4;
reg   [7:0] ap_phi_mux_p_Val2_s_phi_fu_250_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_reg_233;
wire   [7:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_246;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_fu_116;
wire   [0:0] tmp_user_V_fu_304_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond5_fu_313_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond_fu_324_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond5_fu_313_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp2_stage0_subdone) & (ap_phi_mux_eol_2_phi_fu_262_p4 == 1'd1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_reg_388 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b0 == ap_block_pp2_stage0_11001) & (eol_2_reg_259 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_fu_324_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_fu_116 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_fu_324_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp2_stage0_11001) & (eol_2_reg_259 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_predicate_op58_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond5_fu_313_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_487)) begin
        if ((brmerge_reg_397 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_phi_fu_238_p4 = eol_1_reg_211;
        end else if ((brmerge_reg_397 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_reg_259 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((exitcond_reg_388 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_reg_259 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_reg_397 == 1'd0) & (exitcond_reg_388 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_304_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_304_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op58_read_state6 == 1'b1)) | ((exitcond_reg_388 == 1'd0) & (img_data_stream_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op58_read_state6 == 1'b1)) | ((exitcond_reg_388 == 1'd0) & (img_data_stream_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op58_read_state6 == 1'b1)) | ((exitcond_reg_388 == 1'd0) & (img_data_stream_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_reg_259 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_reg_259 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op58_read_state6 == 1'b1)) | ((exitcond_reg_388 == 1'd0) & (img_data_stream_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_reg_259 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_487 = ((exitcond_reg_388 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_reg_233 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_246 = 'bx;

always @ (*) begin
    ap_predicate_op58_read_state6 = ((brmerge_reg_397 == 1'd0) & (exitcond_reg_388 == 1'd0));
end

assign brmerge_fu_338_p2 = (sof_1_fu_116 | ap_phi_mux_eol_phi_fu_203_p4);

assign exitcond5_fu_313_p2 = ((t_V_reg_177 == img_rows_V) ? 1'b1 : 1'b0);

assign exitcond_fu_324_p2 = ((t_V_3_reg_188 == img_cols_V) ? 1'b1 : 1'b0);

assign i_V_fu_318_p2 = (t_V_reg_177 + 32'd1);

assign img_data_stream_V_din = ap_phi_mux_p_Val2_s_phi_fu_250_p4;

assign j_V_fu_329_p2 = (t_V_3_reg_188 + 32'd1);

assign tmp_user_V_fu_304_p1 = AXI_video_strm_V_user_V_0_data_out;
