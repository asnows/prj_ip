...
reg   [0:0] exitcond_reg_284_pp0_iter1_reg;
reg   [31:0] t_V_1_reg_182;
reg    ap_block_state1;
wire   [32:0] r_V_fu_197_p2;
wire   [0:0] exitcond4_fu_208_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [31:0] i_V_fu_213_p2;
reg   [31:0] i_V_reg_279;
...
wire   [31:0] j_V_fu_224_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] axi_last_V_fu_234_p2;
reg   [0:0] axi_last_V_reg_293;
wire   [31:0] tmp_data_V_fu_243_p1;
...
wire   [32:0] lhs_V_cast_fu_193_p1;
wire   [32:0] tmp_cast_fu_230_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond4_fu_208_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_219_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_284 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_user_V_fu_120 <= 1'd0;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_user_V_fu_120 <= 1'd1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_219_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((exitcond_fu_219_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((exitcond_reg_284_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_reg_284 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        video_out_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_fu_219_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond_fu_219_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign AXI_video_strm_V_data_V_1_ack_out = video_out_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = video_out_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = video_out_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = video_out_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = video_out_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = video_out_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = video_out_TREADY;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_reg_284 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((exitcond_reg_284 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((exitcond_reg_284 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((exitcond_reg_284 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((exitcond_reg_284 == 1'd0) & (img_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((exitcond_reg_284_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign axi_last_V_fu_234_p2 = ((tmp_cast_fu_230_p1 == r_V_fu_197_p2) ? 1'b1 : 1'b0);

assign exitcond4_fu_208_p2 = ((t_V_reg_171 == img_rows_V) ? 1'b1 : 1'b0);

assign exitcond_fu_219_p2 = ((t_V_1_reg_182 == img_cols_V) ? 1'b1 : 1'b0);

assign i_V_fu_213_p2 = (t_V_reg_171 + 32'd1);

assign j_V_fu_224_p2 = (t_V_1_reg_182 + 32'd1);

assign lhs_V_cast_fu_193_p1 = img_cols_V;

assign r_V_fu_197_p2 = ($signed(lhs_V_cast_fu_193_p1) + $signed(33'd8589934591));

assign tmp_cast_fu_230_p1 = t_V_1_reg_182;

assign tmp_data_V_fu_243_p1 = img_data_stream_V_dout;

assign video_out_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign video_out_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign video_out_TID = AXI_video_strm_V_id_V_1_data_out;

assign video_out_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign video_out_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign video_out_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign video_out_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign video_out_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];
